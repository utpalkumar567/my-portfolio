...
const Contact = () => {
  return (
    <div className="py-10 md:py-20 md:pl-40" id="contact">
      <h3 className=" text-2xl font-bold text-center text-blue-700 md:text-left">
        Contact Me
      </h3>
      <h3 className="text-3xl font-bold text-center pt-4 text-gray-700 md:text-left md:pb-16 ">
        Don't be shy! Hit me up! 👇
      </h3>
      <div className=" md:flex md:items-center md:gap-8">
        <div className=" flex flex-col items-center justify-center py-8 md:py-0 md:flex-row">
        ...
        <div className=" flex flex-col items-center justify-center pb-8 md:py-0 md:flex-row">
          <span className=" bg-white rounded-full shadow-md shadow-slate-500 w-12 h-12 items-center justify-center flex">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="30"
          ...
          <span className=" md:pl-4">
            ...
            <p className=" text-center hover:text-blue-700 underline">
              <a href="mailto:utpalkumar567@gmail.com">
                utpalkumar567@gmail.com
              </a>
            </p>
          </span>
        </div>
