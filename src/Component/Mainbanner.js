...
const Mainbanner = () => {
  return (
    <div className=" bg-gray-50 h-screen w-full pt-10 pb-5">
      <div>
        <img
          className=" h-96 bg-cover mx-auto border-4 border-black rounded-tl-[60%] rounded-tr-[40%] rounded-br-[30%] rounded-bl-[70%]"
          alt="main"
          src={image}
        ></img>
      </div>
